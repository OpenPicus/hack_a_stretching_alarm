...
extern char XivelyAPIKey[];
extern char XivelyFeedID[];
...
// Resolve which function to use and pass along
	...
	while(curHTTP.byteCount)
	{
		...
		/* Xively */
		else if (memcmppgm2ram(curHTTP.data,(ROM void*)"X-API-KEY", 9) == 0)
		{	
			memcpy(XivelyAPIKey,(void*)&curHTTP.data[10], len-10);
			XivelyAPIKey[len-10]='\0';
		}
		else if (memcmppgm2ram(curHTTP.data,(ROM void*)"X-FEED-ID", 9) == 0)
		{	
			memcpy(XivelyFeedID,(void*)&curHTTP.data[10], len-10);
			XivelyFeedID[len-10]='\0';
		}
	}
